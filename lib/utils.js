...
// 十六进制值转为百分比
const hexPct = (hex) => {
    return !hex ? 1 : (0, exports.fmtInt)(((0, exports.hex2num)(hex) * 100) / 255) / 100;
};
...
const callback = (color, fn, alpha, errorValue) => {
    if ((0, exports.isColor)(color)) {
        const rgba = (0, exports.getRgbaMap)(color);
        return fn(alpha != null && validAlpha(rgba.a) ? (0, converts_1.rgba2rgbByMap)(rgba) : rgba);
    }
